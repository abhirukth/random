...
public class StockManagerTest {
	...
	public void testgetBooksInDemand() throws BookStoreException {
		...
		booksToAdd.add(new ImmutableStockBook(2, "Harry Potter and JUnit2", "JK Unit", (float) 10, NUM_COPIES, 1, 1, 2, false));
		booksToAdd.add(new ImmutableStockBook(3, "Harry Potter and JUnit3", "JK Unit", (float) 10, NUM_COPIES, 0, 1, 5, false));
		booksToAdd.add(new ImmutableStockBook(4, "Harry Potter and JUnit4", "JK Unit", (float) 10, NUM_COPIES, 2, 1, 10, false));
		storeManager.addBooks(booksToAdd);

		var listBooks = storeManager.getBooksInDemand();
    assertTrue(listBooks.size() == 2);
		assertTrue(listBooks.get(0).getISBN() == 2 && listBooks.get(1).getISBN() == 4);
	}
